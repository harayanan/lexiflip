  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute inset-0 backface-hidden rounded-3xl bg-gradient-to-br ${gradientClass} p-6 shadow-2xl flex flex-col items-center justify-center`}
        >
        ...
        <div
          className="absolute inset-0 backface-hidden rotate-y-180 rounded-3xl bg-white dark:bg-gray-900 p-6 shadow-2xl"
        >
